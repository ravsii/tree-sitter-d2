...
enum {
  ...
  sym_shape_label = 18,
  sym_identifier = 19,
  sym_sub_identifier = 20,
  aux_sym_source_file_repeat1 = 21,
  aux_sym_shape_title_repeat1 = 22,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_PIPE] = "|",
  [aux_sym_shape_label_token1] = "shape_label_token1",
  [anon_sym_DOT] = ".",
  ...
  [sym_shape_title] = "shape_title",
  [sym_shape_label] = "shape_label",
  [sym_identifier] = "identifier",
  [sym_sub_identifier] = "sub_identifier",
  [aux_sym_source_file_repeat1] = "source_file_repeat1",
  [aux_sym_shape_title_repeat1] = "shape_title_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_shape_label_token1] = aux_sym_shape_label_token1,
  ...
  [sym_shape_title] = sym_shape_title,
  [sym_shape_label] = sym_shape_label,
  [sym_identifier] = sym_identifier,
  [sym_sub_identifier] = sym_sub_identifier,
  [aux_sym_source_file_repeat1] = aux_sym_source_file_repeat1,
  [aux_sym_shape_title_repeat1] = aux_sym_shape_title_repeat1,
};
...
static inline bool sym__ident_regex_character_set_3(int32_t c) {
  return (c < 6528
    ? (c < 2969
      ? (c < 2160
        ? (c < 1162
...
static inline bool sym__ident_regex_character_set_4(int32_t c) {
  return (c < 6528
    ? (c < 2969
      ? (c < 2144
        ? (c < 1015
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (lookahead == '\t' ||
          lookahead == '\r') SKIP(1)
      if (sym__ident_regex_character_set_1(lookahead)) ADVANCE(50);
      END_STATE();
    case 2:
      if (lookahead == '\n') ADVANCE(36);
      if (lookahead == ':') ADVANCE(29);
    ...
    case 5:
      ...
      if (lookahead == '\t' ||
          lookahead == '\n' ||
          lookahead == '\r') SKIP(5)
      if (sym__ident_regex_character_set_2(lookahead)) ADVANCE(50);
      END_STATE();
    case 6:
    ...
    case 38:
      ...
      END_STATE();
    case 39:
      ACCEPT_TOKEN(aux_sym_shape_label_token1);
      if (lookahead == '|') ADVANCE(38);
      if (lookahead == '\t' ||
          lookahead == '\r' ||
          lookahead == ' ') ADVANCE(39);
    ...
    case 45:
      ...
      if (lookahead == '>') ADVANCE(43);
      if (sym__ident_regex_character_set_3(lookahead)) ADVANCE(50);
      END_STATE();
    case 46:
    ...
    case 50:
      ACCEPT_TOKEN(sym__ident_regex);
      if (sym__ident_regex_character_set_4(lookahead)) ADVANCE(50);
      END_STATE();
    case 51:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_shape_title] = STATE(9),
    [sym_identifier] = STATE(5),
    [aux_sym_source_file_repeat1] = STATE(2),
    [aux_sym_shape_title_repeat1] = STATE(5),
    [ts_builtin_sym_end] = ACTIONS(3),
    [sym_connection] = ACTIONS(5),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [16] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(4),
  [19] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_identifier, 1),
  [21] = {.entry = {.count = 1, .reusable = false}}, SHIFT(12),
  [23] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_shape_title, 1),
  [25] = {.entry = {.count = 1, .reusable = false}}, SHIFT(6),
  [27] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2),
  [29] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2), SHIFT_REPEAT(6),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2), SHIFT_REPEAT(4),
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_identifier, 2),
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sub_identifier, 2),
  [39] = {.entry = {.count = 1, .reusable = false}}, SHIFT(13),
  [41] = {.entry = {.count = 1, .reusable = false}}, SHIFT(10),
  [43] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 2),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 2),
  ...
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_shape_label, 2),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shape_label, 2),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_shape_label, 4),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shape_label, 4),
