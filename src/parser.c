...
enum ts_symbol_identifiers {
  ...
  sym_block = 47,
  sym_label = 48,
  sym_label_codeblock = 49,
  sym_codeblock_content = 50,
  sym__label_constraints = 51,
  sym_label_constraint = 52,
  sym__label_literal = 53,
  sym__label_base = 54,
  sym_connection_reference = 55,
  sym_identifier = 56,
  sym__identifier_base = 57,
  aux_sym__fields = 58,
  aux_sym__ident = 59,
  aux_sym_source_file_repeat1 = 60,
  aux_sym__expr_repeat1 = 61,
  aux_sym_arguments_repeat1 = 62,
  aux_sym_arguments_repeat2 = 63,
  aux_sym_arguments_repeat3 = 64,
  aux_sym_block_repeat1 = 65,
  aux_sym_codeblock_content_repeat1 = 66,
  aux_sym__label_constraints_repeat1 = 67,
  aux_sym__label_literal_repeat1 = 68,
  aux_sym_identifier_repeat1 = 69,
  anon_alias_sym_returns = 70,
};
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(151)] = 2681,
  [SMALL_STATE(152)] = 2694,
  [SMALL_STATE(153)] = 2707,
  [SMALL_STATE(154)] = 2716,
  [SMALL_STATE(155)] = 2729,
  [SMALL_STATE(156)] = 2742,
  [SMALL_STATE(157)] = 2755,
  [SMALL_STATE(158)] = 2768,
