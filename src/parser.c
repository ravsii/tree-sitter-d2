...
enum {
  ...
  aux_sym_shape_title_repeat1 = 21,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (lookahead == '\t' ||
          lookahead == '\r') SKIP(1)
      if (sym__ident_regex_character_set_1(lookahead)) ADVANCE(48);
      END_STATE();
    case 2:
      if (lookahead == '\n') ADVANCE(35);
      if (lookahead == ':') ADVANCE(28);
    ...
    case 44:
      ...
      if (lookahead == '>') ADVANCE(42);
      if (sym__ident_regex_character_set_2(lookahead)) ADVANCE(48);
      END_STATE();
    case 45:
    ...
    case 48:
      ACCEPT_TOKEN(sym__ident_regex);
      if (sym__ident_regex_character_set_3(lookahead)) ADVANCE(48);
      END_STATE();
    case 49:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_shape_title] = STATE(7),
    [sym_identifier] = STATE(4),
    [aux_sym_source_file_repeat1] = STATE(2),
    [aux_sym_shape_title_repeat1] = STATE(4),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [16] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(6),
  [19] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_shape_title, 1),
  [21] = {.entry = {.count = 1, .reusable = false}}, SHIFT(5),
  [23] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2),
  [25] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2), SHIFT_REPEAT(5),
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2), SHIFT_REPEAT(6),
  ...
  [41] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 2),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 3),
  [45] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 3),
  ...
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_shape_label, 2),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shape_label, 2),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_shape_label, 4),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shape_label, 4),
