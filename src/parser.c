  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == '\r' ||
          lookahead == ' ') SKIP(0)
      if (sym__ident_regex_character_set_1(lookahead)) ADVANCE(42);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(13);
      if (lookahead == '-') ADVANCE(23);
    ...
    case 7:
      ...
      if (sym__ident_regex_character_set_2(lookahead)) ADVANCE(42);
      END_STATE();
    case 8:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shape_title, 1),
  [23] = {.entry = {.count = 1, .reusable = false}}, SHIFT(5),
  [25] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_shape_title_repeat1, 2),
  [29] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2), SHIFT_REPEAT(5),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_shape_title_repeat1, 2), SHIFT_REPEAT(6),
  ...
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 2),
  [45] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 2),
  ...
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shape_label, 2),
  [63] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shape_label, 4),
};
